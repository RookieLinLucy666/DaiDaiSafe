...
contract Entry {
    ...
    function getBytes256(string memory) public view returns (bytes1[256] memory) {}
    ...
    function getBool(string memory) public view returns (bool) {}
    ...
    function set(string memory, bool) public {}
}
